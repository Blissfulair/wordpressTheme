...
*/
 ?>
 <article id="post-<?php the_ID(); ?>" <?php post_class('sun-format-gallery'); ?>>
   <header class="entry-header text-center">
     <?php if(sun_get_post_image()): ?>
        <?php $attachments = sun_get_carousel_data(sun_get_post_image(10));?>
         <div id="post-gallery-<?php the_ID(); ?>" class="carousel slide sun-gallery-slide" data-ride="carousel">
